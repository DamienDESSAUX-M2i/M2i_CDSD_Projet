...
\begin{frame}{Contexte et besoin métier}
	...
	La retranscription manuelle d’une performance de guitare vers un format éditable constitue une tâche \textbf{chronophage}, nécessitant une \textbf{expertise musicale avancée} et difficilement \textbf{industrialisable} pour des usages pédagogiques ou créatifs.
...
\begin{frame}{Contraintes budgétaires et choix d’architecture}
	...
	Hypothèse budgétaire : valorisation de la charge projet à 500 € / jour, soit 25 000 € pour 50 jours.
...
%	\end{itemize}
	...
	\begin{block}{\small Impact projet}
		\small Le POC privilégie la reproductibilité et la maîtrise des coûts plutôt que la scalabilité industrielle.
	\end{block}
\end{frame}
...
\begin{frame}{Réalisation du POC}
	...
	\begin{itemize}
		\item Pipelines de téléchargement et d’ingestion des données
...
\begin{frame}{Résultats obtenus}
	...
	\begin{block}{Synthèse}
		Bien que les résultats sont en deçà des espérances, le POC démontre globalement la faisabilité technique de la transcription audio $\rightarrow$ MIDI.
	\end{block}
\end{frame}
...
\begin{frame}{Gouvernance et qualité}
	...
	\begin{columns}[T]
		...
		\begin{itemize}
			...
			\item PostgreSQL utilisé comme source de vérité.
		\end{itemize}
		...
		\begin{itemize}
			...
			\item Versionnement des prétraitements et des datasets.
			\item Tracking des exprimentations.
			%\item Association :
			%\begin{itemize}
		...
		\begin{itemize}
			\item GitHub / Docker / uv / Ruff + Mypy / Tests
		\end{itemize}
