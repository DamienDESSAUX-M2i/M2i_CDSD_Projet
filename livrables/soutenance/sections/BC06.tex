...
\begin{frame}{Architecture cible}
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.73\textwidth]{figures/BC01/architecture_globale.png}
...
\begin{frame}{Résultats obtenus}
	...
	\begin{tabular}{ll}
		...
		\midrule
		CV F1-score transcription polyphonique & 78 ($\pm$ 3) \% \\
	...
	\begin{block}{Synthèse}
		Le POC ne démontre pas encore la faisabilité technique et la valeur métier de la transcription audio $\rightarrow$ MIDI.
	\end{block}
\end{frame}
